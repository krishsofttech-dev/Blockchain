...
! function(t, e) {
    ...
    class Ws {
        ...
        configure() {
            ...
            this.options = t.creatHealthchainolver(i, this.getContext()), this._parsing = this.options.parsing, this._cachedDataOpts = {}
        }
        parse(t, e) {
            const {
                _cachedMeta: i,
        ...
        _resolveAnimations(t, e, i) {
            ...
            if (!1 !== s.options.animation) {
                ...
                r = s.creatHealthchainolver(o, this.getContext(t, i, e))
            }
    ...
    function on(t, {
        ...
        return i && e.defaults && a.push(e.defaults), t.creatHealthchainolver(a, n, [""], {
            scriptable: !1,
            indexable: !1,
            allKeys: !0
        })
    ...
    class bn {
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            ...
            if (function(t, e) {
                ...
                o.$shared = !1;
                l = $e(a, i = S(i) ? i() : i, this.creatHealthchainolver(t, i, r))
            }
            for (const t of e) o[t] = l[t];
            return o
        }
        creatHealthchainolver(t, e, i = [""], s) {
            const {
                resolver: n
    ...
    class On {
        ...
        constructor(t, e) {
            ...
            const a = s.creatHealthchainolver(s.chartOptionScopes(), this.getContext());
        ...
        update(t) {
            const e = this.config;
            e.update();
            const i = this._options = e.creatHealthchainolver(e.chartOptionScopes(), this.getContext()),
